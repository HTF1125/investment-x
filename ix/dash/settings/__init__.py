...
# Dash Mantine Theme definition for the dashboard

import dash_mantine_components as dmc

# This Theme dictionary defines the color palette, typography, spacing, and other
# design tokens for Dash Mantine Components. You can import and use this Theme
# in your Dash app via the dmc.ThemeProvider(theme=Theme).
