"""Statistical functions: cycle fitting, variance, entropy, scalers."""
...
# Backward compat alias (avoid name collision with preprocessing.StandardScaler class)
StandardScaler = RollingZScore
...
def ENTP(data: pd.Series, base: float = 2.0) -> float:
    """Entropy (ENTP) — measures unpredictability of the data."""
    p = data / data.sum()
