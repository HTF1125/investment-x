...
def Correlation(
    *codes: str,
    ...
    """
    from ix.common.quantitative import correlation_matrix
...
def RollingCorrelation(
    ...
    """
    from ix.common.quantitative import rolling_correlation
    from ix.db.query import Series
...
def Regression(
    ...
    *x_codes: str,
    ...
    """
    from ix.common.quantitative import multi_factor_regression
    from ix.db.query import Series
...
def RollingBeta(
    ...
    """
    from ix.common.quantitative import rolling_beta
    from ix.db.query import Series
...
def PCA(
    *codes: str,
    ...
    """
    from ix.common.quantitative import pca_decomposition
    from ix.db.query import Series
...
def VaR(
    ...
    """
    from ix.common.quantitative import historical_var, parametric_var
    from ix.db.query import Series
...
def ExpectedShortfall(
    ...
    """
    from ix.common.quantitative import expected_shortfall
    from ix.db.query import Series
