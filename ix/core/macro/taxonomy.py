...
def _eps_dispersion_series() -> pd.Series:
    ...
    try:
        ...
        logger.debug("Failed to load EPS dispersion", exc_info=True)
        return pd.Series(dtype=float)
...
def _us_10y_breakeven_weekly() -> pd.Series:
    ...
    try:
        ...
        logger.debug("Failed to load US 10Y breakeven", exc_info=True)
        return pd.Series(dtype=float)
...
def _cftc_position(asset: str) -> pd.Series:
    ...
    try:
        ...
        logger.debug("Failed to load CFTC position for '%s'", asset, exc_info=True)
    return pd.Series(dtype=float)
...
# ---------------------------------------------------------------------------
# Geographic scope tags for index-factor eligibility filtering
# ---------------------------------------------------------------------------

GEO_TAGS: dict[str, str] = {
    # ── Growth ────────────────────────────────────────────────────────
    "PMI Mfg Diffusion": "GLOBAL",
    "PMI Services Diffusion": "GLOBAL",
    "OECD CLI World": "GLOBAL",
    "OECD CLI Developed": "GLOBAL",
    "OECD CLI Emerging": "GLOBAL",
    "ISM New Orders": "US",
    "ISM NO-Inv Spread": "US",
    "ISM Services Breadth": "US",
    "ISM Mfg Breadth": "US",
    "ISM Mfg Momentum": "US",
    "CESI Breadth": "GLOBAL",
    "CESI Momentum": "GLOBAL",
    "Asian Exports Diffusion": "ASIA",
    "Asian Exports Momentum": "ASIA",
    "Global Trade Composite": "GLOBAL",
    "Korea Semi Exports": "ASIA",
    "SPX Revision Ratio": "US_DOMINANT",
    "EPS Breadth": "GLOBAL",
    "EPS Dispersion Z": "US_DOMINANT",
    "Earnings Momentum": "US_DOMINANT",
    "Earnings Composite": "US_DOMINANT",
    "Copper/Gold": "GLOBAL",
    "Small/Large Cap": "US_DOMINANT",
    "Cyclical/Defensive": "US_DOMINANT",
    "Baltic Dry Index": "GLOBAL",
    "SOX Momentum": "US_DOMINANT",
    "SOX/SPX Ratio": "US_DOMINANT",
    "GDPNow": "US",
    "Weekly Economic Index": "US",
    "WEI Momentum": "US",
    "Initial Claims": "US",
    "Nowcast Composite": "US",
    "Industrial Production YoY": "US",
    "Capacity Utilization": "US",
    "Housing Starts": "US",
    "Building Permits": "US",
    "Housing Affordability": "US",
    "Baltic Dry Momentum": "GLOBAL",
    "Global Composite PMI": "GLOBAL",
    "Global Mfg PMI": "GLOBAL",
    "Global Services PMI": "GLOBAL",
    "China Caixin Mfg PMI": "CHINA_EM",
    "China Caixin Services PMI": "CHINA_EM",
    "Eurozone Composite PMI": "EUROPE",
    "ASEAN Mfg PMI": "ASIA",
    "US OECD CLI": "US",
    "Consumer Confidence": "US",
    "Consumer Confidence Present": "US",
    "UMich Consumer Sentiment": "US",
    "NFIB Small Biz Optimism": "US",
    "CFNAI 3M MA": "US",
    "Leading Economic Index": "US",
    "Durable Goods YoY": "US",
    "Retail Sales ex-Auto": "US",
    "JOLTS Job Openings": "US",
    "NFP MoM Change": "US",
    "Temp Help Employment": "US",
    "Philly Fed Mfg": "US",
    "Empire State Mfg": "US",
    "China IP YoY": "CHINA_EM",
    "China Official Mfg PMI": "CHINA_EM",
    "Case-Shiller Home Prices": "US",
    "New Home Sales": "US",
    # ── Inflation ─────────────────────────────────────────────────────
    "Inflation Surprise": "US",
    "10Y Breakeven": "US_DOMINANT",
    "Breakeven Momentum": "US_DOMINANT",
    "Commodity Inflation Pressure": "GLOBAL",
    "CRB Index": "GLOBAL",
    "WTI Crude": "GLOBAL",
    "Natural Gas": "GLOBAL",
    "ISM Prices Paid": "US",
    "CPI 3M Annualized": "US",
    "PCE Core YoY": "US",
    "Cleveland Fed Inflation Nowcast": "US",
    "Sticky CPI 3M Ann": "US",
    "5Y Breakeven": "US_DOMINANT",
    "5Y5Y Forward Inflation Swap": "US_DOMINANT",
    "1Y Inflation Swap": "US_DOMINANT",
    "2Y Inflation Swap": "US_DOMINANT",
    "Euro 5Y5Y Forward Swap": "EUROPE",
    "Citi Inflation Surprise US": "US",
    "Citi Inflation Surprise EZ": "EUROPE",
    "Citi Inflation Surprise UK": "EUROPE",
    "Citi Inflation Surprise JP": "ASIA",
    "Citi Inflation Surprise G10": "GLOBAL",
    "Citi Inflation Surprise EM": "CHINA_EM",
    "Citi Inflation Surprise World": "GLOBAL",
    "PPI Final Demand YoY": "US",
    "PPI Core YoY": "US",
    "Import Prices YoY": "US",
    "Atlanta Fed Wage Growth": "US",
    "Avg Hourly Earnings": "US",
    "ECI YoY": "US",
    "Shelter CPI": "US",
    "Used Cars CPI": "US",
    "NFIB Price Plans": "US",
    "NFIB Higher Prices": "US",
    "UMich 1Y Inflation Expect": "US",
    "UMich 5Y Inflation Expect": "US",
    "Eurozone HICP YoY": "EUROPE",
    # ── Liquidity ─────────────────────────────────────────────────────
    "Fed Total Assets": "US_DOMINANT",
    "Fed Assets YoY": "US_DOMINANT",
    "Fed Assets Momentum": "US_DOMINANT",
    "Fed Net Liquidity": "US_DOMINANT",
    "G4 Balance Sheet Total": "GLOBAL",
    "G4 Balance Sheet YoY": "GLOBAL",
    "CB Liquidity Composite": "GLOBAL",
    "TGA Drawdown": "US",
    "Treasury Net Issuance": "US",
    "US M2": "US_DOMINANT",
    "Global M2 YoY": "GLOBAL",
    "Global Liquidity YoY": "GLOBAL",
    "China M2 YoY": "CHINA_EM",
    "China M2 Momentum": "CHINA_EM",
    "Credit Impulse": "US_DOMINANT",
    "Bank Credit Impulse": "US_DOMINANT",
    "Consumer Credit Growth": "US",
    "China Credit Impulse": "CHINA_EM",
    "FCI US": "US_DOMINANT",
    "Financial Conditions Credit": "US_DOMINANT",
    "Policy Rate": "US_DOMINANT",
    "Rate Cut Expectations": "US_DOMINANT",
    "Rate Expectations Momentum": "US_DOMINANT",
    "Rate Cut Probability Proxy": "US_DOMINANT",
    "Term Premium": "US_DOMINANT",
    "G4 Rate Divergence": "GLOBAL",
    "US 3M10Y": "US_DOMINANT",
    "US 2s10s": "US_DOMINANT",
    "US 10Y Real": "US_DOMINANT",
    "PBoC Easing Proxy": "CHINA_EM",
    "EM Sovereign Spread": "CHINA_EM",
    "Margin Debt YoY": "US",
    "Treasury Securities Held": "US_DOMINANT",
    "US M2 Level (Bloomberg)": "US_DOMINANT",
    "ECB M2 YoY": "EUROPE",
    "Senior Loan Officer Survey": "US",
    "Commercial Paper Outstanding": "US",
    "Bank Loans & Leases": "US",
    "Business Loans": "US",
    "Consumer Revolving Credit": "US",
    "Real Estate Loans": "US",
    "Bloomberg US FCI": "US_DOMINANT",
    "Chicago Fed NFCI": "US_DOMINANT",
    "Chicago Fed NFCI Credit": "US_DOMINANT",
    "ECB Deposit Rate": "EUROPE",
    "1Y Real Interest Rate": "US_DOMINANT",
    "5Y Real Yield": "US_DOMINANT",
    "Real 10Y Core CPI Based": "US_DOMINANT",
    "EMBI Global Spread": "CHINA_EM",
    "EM Currency Index": "CHINA_EM",
    "Reserve Balances": "US_DOMINANT",
    "China New Loans": "CHINA_EM",
    # ── Tactical ──────────────────────────────────────────────────────
    "VIX": "US_DOMINANT",
    "VIX Term Structure": "US_DOMINANT",
    "VIX Term Spread": "US_DOMINANT",
    "VIX-Realized Vol Spread": "US_DOMINANT",
    "Vol Risk Premium Z": "US_DOMINANT",
    "SKEW Index": "US_DOMINANT",
    "SKEW Z-Score": "US_DOMINANT",
    "VVIX/VIX Ratio": "US_DOMINANT",
    "Gamma Exposure Proxy": "US_DOMINANT",
    "Realized Vol Regime": "US_DOMINANT",
    "HY Spread": "US_DOMINANT",
    "IG Spread": "US_DOMINANT",
    "BBB Spread": "US_DOMINANT",
    "HY/IG Ratio": "US_DOMINANT",
    "HY Spread Momentum": "US_DOMINANT",
    "HY Spread Velocity": "US_DOMINANT",
    "IG/HY Compression": "US_DOMINANT",
    "Credit Stress Index": "US_DOMINANT",
    "Credit Cycle Phase": "US_DOMINANT",
    "FCI Stress": "US_DOMINANT",
    "Credit-Equity Divergence": "US_DOMINANT",
    "Put/Call Z-Score": "US_DOMINANT",
    "ERP Z-Score": "US_DOMINANT",
    "Risk Appetite": "US_DOMINANT",
    "Risk On/Off Breadth": "GLOBAL",
    "US Sector Breadth": "US",
    "US Sector Dispersion": "US",
    "Momentum Breadth": "GLOBAL",
    "Momentum Composite": "GLOBAL",
    "Risk Rotation Index": "US_DOMINANT",
    "Equity/Bond Flow Proxy": "US_DOMINANT",
    "Eq/Bond Correlation Z": "US_DOMINANT",
    "Safe Haven Demand": "US_DOMINANT",
    "Tail Risk Index": "GLOBAL",
    "Cross-Asset Correlation": "GLOBAL",
    "Diversification Index": "GLOBAL",
    "Correlation Surprise": "US_DOMINANT",
    "Dollar Index": "US_DOMINANT",
    "CFTC Extreme Count": "US_DOMINANT",
    "CFTC SPX Net": "US_DOMINANT",
    "CFTC USD Net": "US_DOMINANT",
    "CFTC Gold Net": "US_DOMINANT",
    "CFTC 10Y Net": "US_DOMINANT",
    "CFTC JPY Net": "US_DOMINANT",
    "VXN (Nasdaq Vol)": "US_DOMINANT",
    "RVX (Russell Vol)": "US_DOMINANT",
    "OVX (Oil Vol)": "GLOBAL",
    "GVZ (Gold Vol)": "GLOBAL",
    "Bloomberg HY OAS": "US_DOMINANT",
    "Bloomberg IG OAS": "US_DOMINANT",
    "CMBS OAS": "US",
    "MBS OAS": "US",
    "CBOE Put Volume": "US",
    "CBOE Call Volume": "US",
    "CFTC 2Y Treasury Net": "US_DOMINANT",
    "CFTC EUR Net": "US_DOMINANT",
    "CFTC Oil Net": "US_DOMINANT",
    "NFIB Profits": "US",
    "Gold ETF Demand": "GLOBAL",
    "CB Gold Demand": "GLOBAL",
    "Citi Macro Risk ST": "GLOBAL",
    "Citi Macro Risk LT": "GLOBAL",
    "Citi EM Macro Risk": "CHINA_EM",
    "NYSE Down Volume": "US",
}

INDEX_GEO_ELIGIBILITY: dict[str, set[str]] = {
    "S&P 500": {"GLOBAL", "US_DOMINANT", "US"},
    "Nasdaq 100": {"GLOBAL", "US_DOMINANT", "US"},
    "ACWI": {"GLOBAL", "US_DOMINANT", "US", "EUROPE", "CHINA_EM", "ASIA"},
    "MSCI EM": {"GLOBAL", "US_DOMINANT", "CHINA_EM", "ASIA", "EUROPE"},
    "DAX": {"GLOBAL", "US_DOMINANT", "EUROPE"},
    "Stoxx 50": {"GLOBAL", "US_DOMINANT", "EUROPE"},
    "FTSE 100": {"GLOBAL", "US_DOMINANT", "EUROPE"},
    "Nikkei 225": {"GLOBAL", "US_DOMINANT", "ASIA"},
    "KOSPI": {"GLOBAL", "US_DOMINANT", "ASIA", "CHINA_EM"},
    "Hang Seng": {"GLOBAL", "US_DOMINANT", "ASIA", "CHINA_EM"},
    "Shanghai Comp": {"GLOBAL", "US_DOMINANT", "CHINA_EM"},
}


def get_eligible_factors(index_name: str) -> set[str]:
    """Return set of factor names eligible for the given index."""
    eligible_geos = INDEX_GEO_ELIGIBILITY.get(index_name)
    if eligible_geos is None:
        return set(GEO_TAGS.keys())  # fallback: all factors
    return {name for name, geo in GEO_TAGS.items() if geo in eligible_geos}
