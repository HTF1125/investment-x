...
def Correlation(
    *codes: str,
    ...
    """
    from ix.core.quant import correlation_matrix
...
def RollingCorrelation(
    ...
    """
    from ix.core.quant import rolling_correlation
    from ix.db.query import Series
...
def Regression(
    ...
    *x_codes: str,
    ...
    """
    from ix.core.quant import multi_factor_regression
    from ix.db.query import Series
...
def RollingBeta(
    ...
    """
    from ix.core.quant import rolling_beta
    from ix.db.query import Series
...
def PCA(
    *codes: str,
    ...
    """
    from ix.core.quant import pca_decomposition
    from ix.db.query import Series
...
def VaR(
    ...
    """
    from ix.core.quant import historical_var, parametric_var
    from ix.db.query import Series
...
def ExpectedShortfall(
    ...
    """
    from ix.core.quant import expected_shortfall
    from ix.db.query import Series
