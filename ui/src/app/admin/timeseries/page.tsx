      ...
      <AppShell>
        {!isAdmin ? (
          ...
          <NavigatorShell
            ...
            sidebarIcon={<Server className="w-3.5 h-3.5 text-primary" />}
            sidebarLabel="Admin"
            sidebarContent={
                  ...
                  return (
                    <button
                      ...
                      className={`w-full text-left px-2.5 py-1.5 transition-colors border-l-2 ${
                        active
                          ? 'border-l-primary/70 bg-primary/8 text-foreground'
                          : 'border-l-transparent hover:bg-primary/10 text-muted-foreground hover:text-foreground'
                      }`}
                    >
