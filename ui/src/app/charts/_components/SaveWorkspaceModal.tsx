    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-foreground/40 dark:bg-black/70" onClick={onClose}>
      <div className="bg-card border border-border/50 rounded-[var(--radius)] shadow-lg p-5 w-[340px]" onClick={(e) => e.stopPropagation()}>
        ...
        <input
          ...
          className="w-full px-2.5 py-2 text-[13px] border border-border/50 rounded-[var(--radius)] bg-background text-foreground focus:outline-none focus:border-primary/50 focus:ring-2 focus:ring-primary/10 transition-colors"
          style={formStyle}
        />
        <div className="flex gap-2 mt-4">
          ...
          <button
            ...
            className="flex-1 h-8 rounded-[var(--radius)] text-[12.5px] font-medium bg-foreground text-background hover:opacity-90 transition-colors disabled:opacity-30"
          >
