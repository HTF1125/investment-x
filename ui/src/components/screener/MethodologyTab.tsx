  ...
  return (
    <div className="space-y-4 max-w-3xl">
      ...
      <div className="panel-card p-4">
        ...
        <div className="bg-foreground/[0.03] border border-border/30 rounded-[var(--radius)] p-3 font-mono text-[12px] text-foreground/80">
      ...
      <div className="panel-card p-4">
        ...
        <div className="mt-3 bg-foreground/[0.03] border border-border/30 rounded-[var(--radius)] p-3 font-mono text-[12px] text-foreground/80">
      ...
      <div className="panel-card p-4">
        ...
        <ul className="text-[12px] text-muted-foreground leading-relaxed list-disc pl-5 space-y-1">
      ...
      <div className="panel-card p-4">
        ...
        <div className="space-y-1.5">
          <div className="flex items-center gap-2">
            ...
            <span className="text-[12px] text-foreground/80">Both confirmed: Price {'>'} 50d SMA and {'>'} 200d SMA</span>
          </div>
          <div className="flex items-center gap-2">
            <div className="w-2 h-2 rounded-full bg-warning" />
            <span className="text-[12px] text-foreground/80">Partial: Only one SMA confirmed</span>
          </div>
          <div className="flex items-center gap-2">
            <div className="w-2 h-2 rounded-full bg-destructive" />
            <span className="text-[12px] text-foreground/80">No confirmation: Price below both SMAs</span>
          </div>
        </div>
      </div>
