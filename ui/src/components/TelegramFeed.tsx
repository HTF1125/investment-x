...
export default function TelegramFeed({ embedded }: { embedded?: boolean } = {}) {
  ...
  if (isLoading) {
    return (
      <div className="h-full border border-border/50 rounded-lg bg-background animate-pulse flex items-center justify-center text-muted-foreground text-sm">
  ...
  return (
    <section className={outer}>
      <div className="h-10 flex items-center justify-between px-3 border-b border-border/50 shrink-0">
