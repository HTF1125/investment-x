        ...
        <div className="fixed inset-0 z-[110] flex items-center justify-center p-4">
          ...
          >
            ...
            <div className="flex gap-3">
              <button
                onClick={() => setDeleteConfirm(null)}
                className="flex-1 px-4 py-2.5 border border-border/50 text-muted-foreground text-[12px] font-medium rounded-lg hover:text-foreground transition-all"
              >
                Cancel
              </button>
              <button
                ...
                className="flex-1 px-4 py-2.5 bg-primary text-primary-foreground text-[12px] font-medium rounded-lg hover:opacity-80 transition-opacity disabled:opacity-50"
              >
